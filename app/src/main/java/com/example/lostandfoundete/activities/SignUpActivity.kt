...
import com.example.lostandfoundete.DataClass.User
import com.example.lostandfoundete.databinding.ActivitySignupactivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btRegister.setOnClickListener {
            ...
            if (email.endsWith(emailString)) {
                ...
                Toast.makeText(
                    this, "Use your Gmail address only", Toast.LENGTH_SHORT
                ).show()
            }
        }
    }
